...
class SearchTest: XCTestCase {
    ...
    func testSearchingTab() throws {
        ...
        // Use XCTAssert and related functions to verify your tests produce the correct results.
              ...
              app.tables.containing(.cell, identifier:"Kitchen").element.tap()
              ...
              */
              ...
              app/*@START_MENU_TOKEN@*/.buttons["Kitchen"]/*[[".scrollViews.buttons[\"Kitchen\"]",".buttons[\"Kitchen\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
              app.scrollViews.children(matching: .button).matching(identifier: "Test Blender").element(boundBy: 0).tap()
